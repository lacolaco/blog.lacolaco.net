...
import { DEFAULT_CACHE_MAX_AGE, fetchPageMetadata, type PageMetadata } from '../../libs/embed/fetchPageMetadata';
...
function buildEmbedHtml(metadata: Pick<PageMetadata, 'title' | 'imageUrl'>, url: string): string {
