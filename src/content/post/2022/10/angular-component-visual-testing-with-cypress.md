...
![image](/images/angular-component-visual-testing-with-cypress/Untitled.a317fe12bb5c387e.png)
...
![image](/images/angular-component-visual-testing-with-cypress/Untitled.e96d82b9c295df7c.png)
...
![image](/images/angular-component-visual-testing-with-cypress/Untitled.597a52234081d706.png)
...
![image](/images/angular-component-visual-testing-with-cypress/Untitled.3ff90d79fdbab5b0.png)

比較画面で “Update screenshot” ボタンをクリックすると、新しいスクリーンショットを今後のテスト基準にするようアップデートしてくれる。アップデートしたあとテストを再実行すれば、画像の差分がなくなりテストが成功するようになる。

![image](/images/angular-component-visual-testing-with-cypress/Untitled.8a580edd21d1861d.png)
