...
<figure>
  <img src="/images/firebase-app-hosting-angular-ssr-tryout/Untitled.8bc09272179d1808.png" alt="App Hosting画面の初期状態にある「始める」ボタンをクリックする">
...
<figure>
  <img src="/images/firebase-app-hosting-angular-ssr-tryout/a99d10a4-d385-46c0-b4ea-730a733b0263.1a030c1ccf33f7de.png" alt="GitHubアカウントを連携してレポジトリを選択する">
  <figcaption>GitHubアカウントを連携してレポジトリを選択する</figcaption>
</figure>

<figure>
  <img src="/images/firebase-app-hosting-angular-ssr-tryout/074174fa-3246-4b5b-b747-49c3c636aa43.2b5acfaa20db635f.png" alt="デプロイの設定を行う。今回はライブブランチ（本番環境に対応するブランチ）をmainに設定する">
  <figcaption>デプロイの設定を行う。今回はライブブランチ（本番環境に対応するブランチ）をmainに設定する</figcaption>
</figure>

<figure>
  <img src="/images/firebase-app-hosting-angular-ssr-tryout/80cd3956-ca40-4c08-8234-9ed03c9262be.839169f39149f05c.png" alt="（おそらく）プロジェクト内でユニークなIDを設定する。自動生成されるホスティング用URLのドメインに含められる">
...
![image](/images/firebase-app-hosting-angular-ssr-tryout/Untitled.5868daca72866d0d.png)
...
![image](/images/firebase-app-hosting-angular-ssr-tryout/Untitled.07d5b015c743056b.png)
...
<figure>
  <img src="/images/firebase-app-hosting-angular-ssr-tryout/Untitled.8dfb6996b8ee1286.png" alt="“If you're already using the frameworks experiment in the Firebase CLI, we recommend "graduating" to App Hosting.”">
