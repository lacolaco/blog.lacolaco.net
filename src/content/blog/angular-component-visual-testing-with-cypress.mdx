...
<LinkPreview src="https://github.com/lacolaco/angular-cypress-vistest-demo" />

## CLI ワークスペースに Cypress を導入する

この手順は基本的に Cypress の公式ドキュメントに従う。

<LinkPreview src="https://docs.cypress.io/guides/component-testing/quickstart-angular" />
...
<LinkPreview src="https://docs.cypress.io/guides/tooling/visual-testing" />

<LinkPreview src="https://docs.cypress.io/plugins/directory#Visual%20Testing" />

いくつかプラグインはあるが、比較的新しく作られメンテナンスが活発なものの中で、コンポーネントテストに適合したものとして `@frsource/cypress-plugin-visual-regression-diff` を紹介する。

<LinkPreview src="https://github.com/FRSOURCE/cypress-plugin-visual-regression-diff" />
...
<LinkPreview src="https://docs.cypress.io/guides/component-testing/mounting-angular#What-is-the-Mount-Function" />
...
<Figure
  src="/images/angular-component-visual-testing-with-cypress/e5a7a73a-33f1-4a18-9b6c-b5109340831b/Untitled.png"
  caption=""
/>
...
<Figure
  src="/images/angular-component-visual-testing-with-cypress/f07014ad-0179-4e7a-8977-f890595333c5/Untitled.png"
  caption=""
/>
...
<Figure
  src="/images/angular-component-visual-testing-with-cypress/996a6475-6635-4258-8a50-2ad57b9c9be6/Untitled.png"
  caption=""
/>
...
<Figure
  src="/images/angular-component-visual-testing-with-cypress/f32aacac-c7af-4508-8038-64acb7a3538e/Untitled.png"
  caption=""
/>
...
<Figure
  src="/images/angular-component-visual-testing-with-cypress/7ed9358a-cdb3-4c62-8b78-604e6df85c47/Untitled.png"
  caption=""
/>
...
<LinkPreview src="https://docs.cypress.io/guides/guides/command-line" />
