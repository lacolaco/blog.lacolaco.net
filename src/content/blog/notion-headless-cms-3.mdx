...
<LinkPreview src="https://blog.lacolaco.net/2022/02/notion-headless-cms-2/" />
...
<LinkPreview src="https://docs.github.com/en/actions/using-workflows/triggering-a-workflow" />
...
<LinkPreview src="https://github.com/peter-evans/create-pull-request/blob/main/docs/concepts-guidelines.md#triggering-further-workflow-runs" />
...
<Figure src="/images/notion-headless-cms-3/a77e6ae3-f511-4160-b81b-0582ca167cf7/Untitled.png" caption="" />

Notion に Webhook ができればもう少しスマートになるが、今の API の使い方でもレートリミットなどは問題なさそうなのでしばらくはこのまま運用する。

<LinkPreview src="https://developers.notion.com/reference/request-limits" />
