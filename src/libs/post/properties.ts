...
import manualChannelsJson from '../../content/post/channels.json';
...
export const channels = Channels.parse(mergeByName(notionChannelsJson as Channel[], manualChannelsJson as Channel[]));
