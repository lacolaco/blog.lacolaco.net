...
<div class="block-link block-link-default">
  <iframe src="/embed?url=https://github.com/lacolaco/blog.lacolaco.net" loading="lazy"></iframe>
</div>
`.trim();
      assert.equal(result, expectedHtml);
    });
...
<div class="block-link block-link-google-slides">
  ...
  ></iframe>
    ...
    test('/pubで終わらないGoogleスライドのURLであるとき、Webページカードとして埋め込まれる', async () => {
      ...
      assert.equal(
        result,
        '<div class="block-link block-link-default">\n  <iframe src="/embed?url=https://docs.google.com/presentation/d/e/2PACX-1vRI8Y64QSxw7obQQ_B6Zztyf6NvumARR2t6rWDLpipqcXfBeSssi63dsut3PUCQyUeLj6chqlO7ODOT/edit" loading="lazy"></iframe>\n</div>',
      );
    });
  });
...
<div class="block-link block-link-stackblitz">
  ...
  ></iframe>
    ...
    test('embed=1パラメータがないStackblitzのURLであるとき、Webページカードとして埋め込まれる', async () => {
      ...
      assert.equal(
        result,
        `<div class="block-link block-link-default">\n  <iframe src="/embed?url=https://stackblitz.com/edit/my-project" loading="lazy"></iframe>\n</div>`.trim(),
      );
    });
  });
