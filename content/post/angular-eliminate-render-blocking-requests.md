...
これらの手法は Angular CLI に合理的な形で組み込めるかどうかはまだ保証できないが、現時点でのアイデアとして提案されているものである。
...
[Penthouse](https://github.com/pocketjoso/penthouse) はヘッドレス Chrome を使ってレンダリングしてクリティカル CSS を抽出するため、
