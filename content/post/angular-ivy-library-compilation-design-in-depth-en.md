...
The Ivy compiler generates the code to create the _definition_ from the metadata contained in the decorator.
...
The compiled JavaScript contains the following code.
